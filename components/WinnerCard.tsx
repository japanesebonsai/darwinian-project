...
import type { AgentName, AgentOutput, ArbiterResult } from "@/lib/types";
      ...
      <div className="relative p-8 flex flex-col items-center text-center gap-6">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex items-center gap-2 text-zinc-400">
            Winner: <span className="font-semibold text-white">{meta.label}</span> {meta.emoji}
          </div>
        </div>
